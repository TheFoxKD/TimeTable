...
class Schedule(models.Model):
    user_id = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='id пользователя', unique=False, help_text='Id пользователя должен быть в виде одного числа')
    ...
    def __str__(self):
        return f"{self.user_id.username} - это его расписание"
